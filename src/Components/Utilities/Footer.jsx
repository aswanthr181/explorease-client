...
function Footer() {
  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="text-center">
      <h4 className="text-xl font-extrabold text-gray-900 sm:text-5xl">
    ...
    <div
      className="mt-6 border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24"
    >
