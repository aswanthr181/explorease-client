...
const Slider = () => {
  ...
  return (
    <div className="absolute left-1/2 top-2/4 w-1000 h-600 p-16 bg-gray-50 shadow-lg transform translate-x-[-50%] -translate-y-[-50%]">
      <div className="loadbar" style={{ width: `${loadingProgress}%` }}></div>
      <div id="slide" className="inline-block mt-10" ref={slideRef}>
        {data.map((item) => (
          <div
            key={item.id}
            className="item"
