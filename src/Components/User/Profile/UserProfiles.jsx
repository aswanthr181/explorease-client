...
function UserProfile() {
    ...
    useEffect(()=>{
		console.log('user edit load token==',token);
		if(!token){
			navigate('/login')
		}
	})
	...
	// console.log("userdfghjkl;bnm,.----------",userData.name)
  return (
    <div>
				...
				<div className="max-w-4xl mx-auto px-4 py-8">
					<div className="bg-white shadow-lg rounded-lg overflow-hidden">
						...
						<div className="px-6 py-4">
							...
							<div className="font-bold text-xl mb-2"> {userData?userData.name:''}</div>
							<div className="text-gray-600 mb-4"> {userData?userData.email:''} </div>
							<div className="text-gray-600 mb-4">{userData?userData.mobile:''}</div>
						</div>
						<div className="flex justify-center ">
							<button
								className="btn addBtn form-control mb-5"
								onClick={() => {
